...
-  **谎言与数字**  
  ...
  <dfp>
  “世界上三种谎言,分别是谎言,该死的谎言和统计数字（There are three kinds of lies:lies,damnedlies,and statistics)”.Arthur Balfour / Mark Twain .  
  “数字不会说谎,但说谎的人会玩弄数字。(Figures Don’t Lie, But Liars Do Figure)”  Carroll D. Wright / Charles H. Grosvenor 
  </dfp>

## 开篇--心法篇 
-  **确定性与不确定性**  
  <dfp>
一千个人眼中有一千个Hamlets－Shakespeare  
仁者见仁，智者见智－周易·系辞上  
[诺贝尔经济学奖揭晓 两观点相反者分享诺奖](http://phtv.ifeng.com/program/cjxqs/detail_2013_11/04/30941298_0.shtml )    
代码确定？结果/解读是较为确定的。分析不确定？天气／销量／风险...,又往往寻求先入为主的安慰。最远的距离不是算法之于前手不能会，而是明知10%的中奖率仍纠结如何投入。没有怀疑与反驳，就没有反映出不确定性，要么是已培养起信徒的专家，要么是受众本就不关心你的分析。  
  </dfp>
...
# 小孩的身高体重数据
par(new=T)
plot(身高~体重,d2,family='STHeiti');text(d2[,2],d2[,3],d2[,1],family='STHeiti');
...
plot(身高~体重,d2,axes=F,col="blue",pch=19,type='b',cex=2,xlab='',ylab='',family='STHeiti')
...
##  方法--4.分析工具
Gartner：Magic Quadrant for...   by [gartner DataScience](https://www.gartner.com/doc/reprints?id=1-3TK9NW2&ct=170215&st=sb)  
![gartner](../pic/GanrtnerAnalyze2017.png)  


##  方法--4.分析工具
Gartner：Magic Quadrant for...   by [gartner BI](https://www.gartner.com/doc/reprints?id=1-3TYE0CD&ct=170221&st=sb)   
![gartner](../pic/GanrtnerBI2017.png)  
...
[CRISP-DM](http://kb.cnblogs.com/page/76804/)   
[POLL CRISP-DM](http://www.kdnuggets.com/polls/2014/analytics-data-mining-data-science-methodology.html)   

![crisp-dm](../pic/crispdm.png)  
...
```{r,echo=FALSE}
par(mfrow = c(1, 2));
hist(rnorm(500),axes = FALSE,xlab = NULL,ylab = NULL, main = '正妹正态',family='STHeiti')
hist(rf(500,20,5),axes = FALSE,xlab = NULL,ylab = NULL, main = '歪妹歪态',family='STHeiti')
```
