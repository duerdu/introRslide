...
merge(data.frame(id=1:4,a="d1"),data.frame(id=2:5,b="d2"))  # by.x="id",by.y="id"
```
...
```{r,eval=FALSE}
library(RMySQL)
db="rdb";u="ruser";pa="rpass";h="127.0.0.1";po=3306;
...
d1=dbGetQuery(conn, "SELECT * FROM babyweight limit 3");d1  #dbSendQuery,dbFetch,dbClearResult
dbDisconnect(conn)
```
